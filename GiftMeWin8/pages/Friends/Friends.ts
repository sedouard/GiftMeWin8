...
interface PageArgs {
    client: GiftMeClientLibrary;
    friend: Friend;
}
var g_Client: GiftMeClientLibrary;
var g_Friends: Friend[];
(function () {
    "use strict";
    ...
    WinJS.UI.Pages.define("/pages/Friends/Friends.html", {
        ...
        ready: function (element, options: string) {
        ...
        _itemInvoked: function (args)  {
            ...
            var friend: Friend = g_Friends[args.detail.itemIndex];
            var passedArgs: PageArgs = { friend: friend, client: g_Client }
