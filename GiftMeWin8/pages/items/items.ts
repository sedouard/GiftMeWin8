...
var g_Client: GiftMeClientLibrary;
var g_Friend: Friend;
var g_GiftSuggestions: GiftSuggestion[];
(function () {
    "use strict";
    ...
    ui.Pages.define("/pages/items/items.html", {
        ...
        ready: function (element, options: PageArgs) {
            ...
            g_Client.getSuggestions(g_Friend, (suceeded, results) => {
                ...
                publicMembers.itemList.forEach((value, index, array) => {
        ...
        _itemInvoked: function (args) {
            ...
            var suggestion: GiftSuggestion = g_GiftSuggestions[args.detail.itemIndex];
...
function showProgressRing(show: Boolean) {
    if (show) {
        $("#ui_ProgRing").show();
    }
    else {
